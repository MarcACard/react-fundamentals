...
In the process of generating HTML, a browser also created the 'DOM' which
enables you to interact with content within the webpage through JavaScript. HTML
Elements can be created, modified and removed through the DOM.

Things to remember:

- Use variable declarations dummy, this isn't python :Z
- `document` give you access to DOM
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=marcacard%40gmail.com).
