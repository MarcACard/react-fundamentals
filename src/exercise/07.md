...
It is very common to render a list of items contained within an array in react.
When rending a list, the `key` prop should be used to help React keep track of
elements between updates.

The `key` prop should be a unique identifier that is not the index.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=marcacard%40gmail.com).
