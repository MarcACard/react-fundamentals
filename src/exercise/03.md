...
JSX is syntactic sugar to creating React elements. Using JSX is an abstraction
from using the raw React API where you write in a syntax that nearly HTML with a
few changes. Using JSX requires additional tools like babel to compile JSX.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=marcacard%40gmail.com).
