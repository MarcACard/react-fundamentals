...
Calling on custom components anything included within JSX is passed to the
function as an object. This is referenced as "props" or properties.

You can destructure these props and create components that accept custom styles
by add class names or through inline styles. This is very efficient by creating
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=marcacard%40gmail.com).
